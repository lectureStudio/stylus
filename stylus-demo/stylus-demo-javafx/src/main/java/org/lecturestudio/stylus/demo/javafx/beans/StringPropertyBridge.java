...
import org.lecturestudio.stylus.demo.beans.StringProperty;

public class StringPropertyBridge extends StringPropertyBase {
	...
	public StringPropertyBridge(StringProperty property) {
